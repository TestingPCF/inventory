...
//
//		mockMvc.perform(get("/api/inventory/{productCode}", "I002")).andExpect(status().isNotFound())
//				.andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
...
//
//		doReturn(mockItem).when(service).saveInventory(any());
//
//		mockMvc.perform(
//				post("/api/inventory").contentType(MediaType.APPLICATION_JSON).content(asJsonString(inventoryRequest)))
//				.andExpect(status().isCreated()).andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
//				.andExpect(jsonPath("$.productCode", is("I003"))).andExpect(jsonPath("$.quantity", is(10)))
//				.andExpect(jsonPath("$.activeStatus", is(true))).andExpect(jsonPath("$.inStock", is(true)));
//
//	}
//
...
//
//		dstatic String asJsonString(final Object obj){
//	        try{
//	            return  new ObjectMapper().writeValueAsString(obj);
//	        }catch (Exception e){
//	            throw new RuntimeException(e);
//	        }
//	    }oReturn(mockItem).when(service).updateInventory(any());
//
//		mockMvc.perform(
//				put("/api/inventory").contentType(MediaType.APPLICATION_JSON).content(asJsonString(inventoryRequest)))
//				.andExpect(status().isAccepted())
//				.andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
//				.andExpect(jsonPath("$.productCode", is("I003"))).andExpect(jsonPath("$.quantity", is(12)))
//				.andExpect(jsonPath("$.activeStatus", is(true))).andExpect(jsonPath("$.inStock", is(true)));
//
//	}
//
