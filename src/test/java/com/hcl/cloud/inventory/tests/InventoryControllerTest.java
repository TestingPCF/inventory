 ...
 * com.hcl.cloud.inventory.dto.InventoryItem; import
 * com.hcl.cloud.inventory.dto.InventoryItemRequest;
 * 
 * ////import static org.hamcrest.CoreMatchers.any; //import static
 * org.hamcrest.Matchers.is; ////import static org.mockito.ArgumentMatchers.any;
 * ////import static org.mockito.Matchers.any; //import static
 * org.mockito.Mockito.doReturn; //import static org.mockito.Mockito.doThrow;
 * //import static
 * org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
 * //import static
 * org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post;
 ...
 * com.hcl.cloud.inventory.dto.InventoryItem; //import
 * com.hcl.cloud.inventory.dto.InventoryItemRequest; //import
 * com.hcl.cloud.inventory.exception.ApiRuntimeException; //import
 * com.hcl.cloud.inventory.service.InventoryService; // //import static
 * org.hamcrest.Matchers.is; //import static
 * org.mockito.ArgumentMatchers.isNotNull; //import static
 ...
 * 
 * 
 * import com.hcl.cloud.inventory.exception.ApiRuntimeException; import
 * com.hcl.cloud.inventory.service.InventoryService;
 * 
 ...
 * 
 * @Test //@DisplayName("Get  /api/inventory/I001 - Found") public void
 ...
 * }
 * 
 * @Test //@DisplayName("Get /api/inventory/I002 - Not Found") public void
 * testGetInventoryByProductCodeNotFound() throws Exception {
 * 
 * ApiRuntimeException exception = new ApiRuntimeException(404, 404,
 ...
 * .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
 * .andExpect(jsonPath("$.code", is(404))) .andExpect(jsonPath("$.message",
 * is("Product does not Exists")));
 * 
 * }
 * 
 * 
 * 
 * 
 * @Test //@DisplayName("Post /api/inventory -- Create Inventory") public void
 * testCreateInventory() throws Exception{
 * 
 ...
 * .content(asJsonString(inventoryRequest))) .andExpect(status().isCreated())
 * .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
 ...
 * }
 * 
 * @Test //@DisplayName("Post /api/inventory -- Inventory Not Created") public
 * void testInventoryAlreadyCreatedError() throws Exception{
 * 
 * InventoryItemRequest inventoryRequest = new InventoryItemRequest("I003",10);
 * ApiRuntimeException exception = new ApiRuntimeException(400, 400,
 * "Product already Exists");
 * 
 * doThrow(exception) .when(service).saveOrUpdateInventory(any());
 * 
 * mockMvc.perform(post("") .contentType(MediaType.APPLICATION_JSON)
 * .content(asJsonString(inventoryRequest))) .andExpect(status().isBadRequest())
 * .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
 * .andExpect(jsonPath("$.code", is(400))) .andExpect(jsonPath("$.message",
 ...
 * }
 * 
 * @Test //@DisplayName("Put /api/inventory -- Update Inventory") public void
 * testUpateInventory() throws Exception{
 * 
 ...
 * .content(asJsonString(inventoryRequest))) .andExpect(status().isAccepted())
 * .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
 * .andExpect(jsonPath("$.skuCode",is("I003")))
 * .andExpect(jsonPath("$.quantity",is(12)))
 * .andExpect(jsonPath("$.activeStatus",is(true)))
 ...
 * 
 * 
 * @Test //@DisplayName("Put /api/inventory -- UpateInventoryProductNotFound ")
 ...
 * 
 * mockMvc.perform(put("") .contentType(MediaType.APPLICATION_JSON)
 * .content(asJsonString(inventoryRequest))) .andExpect(status().isNotFound())
 * .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
 * .andExpect(jsonPath("$.code", is(404))) .andExpect(jsonPath("$.message",
 * is("Product does not Exists")));
 * 
 ...
 * ) public void testUpateInventoryInsufficientInventoryError() throws
 * Exception{
 * 
 * InventoryItemRequest inventoryRequest = new InventoryItemRequest("I003",12);
 * InventoryItem mockItem = new InventoryItem("product1231", "I003", 10, true);
 ...
 * 
 * @Test //@DisplayName("Post /api/inventory -- Create Inventory") public void
 * testisProductQuantityAvailable() throws Exception{
 * 
 * // InventoryItemRequest inventoryRequest = new
 * InventoryItemRequest("I003",10); // InventoryItem mockItem = new
 * InventoryItem("product1231", "I003", 10, true);
 * 
