...
public class InventoryServiceTest {
	...
	public void testConsumeInventoryWithProductNotAvailable() throws Exception{
		...
		//doReturn(Optional.of(mockItem)).when(repository).findBySkuCodeAndActiveStatus("I001", true);
		//Assertions.assertThrows(ApiRuntimeException.class, ()->service.getInventoryItem("HSIAJB"));
...
//	@Test 
//	public void testConsumeInventory() throws Exception{
//		InventoryItemRequest mockItemRequest = new InventoryItemRequest("HSIAJB", 10l);
//		//InventoryItem mockItem = new InventoryItem("HSIAJB", "I01123", 10, true);
//		//doReturn(mockItem).when(repository).save(mockItem);
//		//service.getInventoryItem(mockItem.getSkuCode());
//		Optional<InventoryItem> existingItem=service.getInventoryItem(mockItemRequest.getSkuCode());
//		Assertions.assertThrows(ApiRuntimeException.class, ()->service.updateInventory(mockItemRequest));
//	}
